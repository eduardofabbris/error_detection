// ======================================================================
// psoc6_dut.v generated from TopDesign.cysch
// 09/27/2024 at 21:50
...
module SCB_UART_PDL_v2_0_0 (
	...
	cy_clock_v1_0
		#(.id("93a697c3-2434-415a-a3d0-78047eb81350/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("93a697c3-2434-415a-a3d0-78047eb81350/65f3af6c-759b-4ccb-8c66-5c95ba1f5f4f"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("93a697c3-2434-415a-a3d0-78047eb81350/b7e8018e-1ef7-49c0-b5a5-61641a03e31c"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("1"),
...
module Scan_ADC_v3_10_1 (
	...
	cy_clock_v1_0
		#(.id("6518f2c4-435f-40f3-8f46-bee690bff39c/f7143d07-534d-4542-813a-8bb23ceb1ae9"),
...
// MCWDT_PDL_v1_10(C0_enable=true, C0ClearOnMatch=0, C0Match=1, C0Mode=2, C1_enable=false, C1ClearOnMatch=0, C1Match=32768, C1Mode=0, C2_enable=false, C2Mode=0, C2Period=16, CascadeC0C1=false, CascadeC1C2=false, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=MCWDT_PDL_v1_10, CY_CONFIG_TITLE=WD_reset, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=WD_reset, CY_INSTANCE_SHORT_NAME=WD_reset, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=mcwdt, CY_PDL_DRIVER_REQ_VERSION=1.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=WD_reset, )
module MCWDT_PDL_v1_10_4 (
    interrupt);
    output      interrupt;
...
// TCPWM_Counter_PDL_v1_0(CaptureInput=7, CaptureInputMasked=3, ClockPrescaler=0, Compare0=16384, Compare1=16384, CompareOrCapture=2, CountDirection=0, CountInput=7, CountInputMasked=3, EnableCompareSwap=false, InterruptSource=0, Period=4294967295, ReloadInput=7, ReloadInputMasked=3, Resolution=32, RunMode=1, StartInput=7, StartInputMasked=3, StopInput=7, StopInputMasked=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_Counter_PDL_v1_0, CY_CONFIG_TITLE=Stopwatch, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Stopwatch, CY_INSTANCE_SHORT_NAME=Stopwatch, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=tcpwm, CY_PDL_DRIVER_REQ_VERSION=1.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Stopwatch, )
...
module top ;
    ...
    Scan_ADC_v3_10_1 ADC (
        ...
        .t_dav(Net_1147),
        .t_fvalid(Net_1148),
        .t_fvinternal(Net_1149[1:0]),
        .t_fvout(Net_1150),
        .vagnd(Net_1151),
        .vinPlus_0(Net_1095));

    VDAC12_PDL_v2_0_3 DAC (
        .clock(Net_1087),
        .strobe(1'b0),
        .trigger(Net_1112),
        .vout(Net_1095),
	...
	wire [0:0] tmpFB_0__commonPin_net;
	wire [0:0] tmpIO_0__commonPin_net;
	electrical [0:0] tmpSIOVREF__commonPin_net;
	...
	cy_mxs40_gpio_v1_0
		...
		commonPin
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__commonPin_net[0:0]}),
		  .analog({Net_1095}),
		  .io({tmpIO_0__commonPin_net[0:0]}),
		  .siovref(tmpSIOVREF__commonPin_net));


    MCWDT_PDL_v1_10_4 WD_reset (
        .interrupt(Net_841));


	cy_clock_v1_0
		#(.id("40b36ba4-4e2d-4092-bde5-c54e99117dc7"),
		  .source_clock_id("2FB4EC85-8328-4C5A-9ED9-8B63060178EB"),
		  .divisor(0),
		  .period("2000000000"),
		  .is_direct(0),
    ...
    TCPWM_Counter_PDL_v1_0_6 Stopwatch (
        .capture(1'b0),
        .clock(Net_1075),
        .compare(Net_1074),
        .count(1'b1),
	...
	cy_clock_v1_0
		#(.id("6a64db77-c9bc-4b0b-a8f8-21a2e2753ee2"),
		  .source_clock_id("2FB4EC85-8328-4C5A-9ED9-8B63060178EB"),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpFB_0__ALIVE_SIGNAL_net;
	wire [0:0] tmpIO_0__ALIVE_SIGNAL_net;
	electrical [0:0] tmpSIOVREF__ALIVE_SIGNAL_net;

	cy_mxs40_gpio_v1_0
		#(.id("a9de8a96-bf5c-443a-8e73-d8748f5789f6"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
		...
		ALIVE_SIGNAL
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__ALIVE_SIGNAL_net[0:0]}),
		  .io({tmpIO_0__ALIVE_SIGNAL_net[0:0]}),
		  .siovref(tmpSIOVREF__ALIVE_SIGNAL_net));
	...
	cy_mxs40_gpio_v1_0
		#(.id("1740f01c-2ab9-4efb-a61a-c47317cd8091"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
